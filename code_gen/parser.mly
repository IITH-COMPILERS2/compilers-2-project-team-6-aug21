...
statement:
  	...
  	| STATE ARROW expr SEMICOLON {print_endline "change in transition";Transition(Ident($1),$3)} 
  	| STATE ARROW DEFSTATE SEMICOLON {print_endline "default transition";Transition(Ident($1),IntLit(1))} /*Star evaluates to IntLit 1 because that's True in StateMap*/
    ...
    /*| PRINT LPAREN APOS ID APOS RPAREN SEMICOLON        {print_endline "found printf statement"; Print2($2)}     | PRINT LPAREN APOS expr APOS RPAREN SEMICOLON        */
